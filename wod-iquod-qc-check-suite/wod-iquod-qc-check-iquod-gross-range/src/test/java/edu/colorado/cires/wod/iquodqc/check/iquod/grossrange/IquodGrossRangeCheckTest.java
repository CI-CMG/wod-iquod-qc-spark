    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(100D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(100.00000001)
                    .build()))
                .build()
        ))
        .build();
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(1D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(20.0)
                    .build()))
                .build(),
            Depth.builder().withDepth(2D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(-5.0)
                    .build()))
                .build(),
            Depth.builder().withDepth(3D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(16.0)
                    .build()))
                .build(),
            ...
            Depth.builder().withDepth(5D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(101.0)
                    .build()))
                .build()
        ))
        .build();
