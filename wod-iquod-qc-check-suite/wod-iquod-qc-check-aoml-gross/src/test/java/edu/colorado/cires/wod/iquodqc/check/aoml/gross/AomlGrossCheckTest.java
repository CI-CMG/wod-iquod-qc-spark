...
public class AomlGrossCheckTest {
  ...
  private final AomlGrossCheck check = (AomlGrossCheck) ServiceLoader.load(CastCheck.class).iterator().next();
        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(0D)
                .withData(Collections.singletonList(ProfileData.builder()
                    ...
                    .withVariable(TEMPERATURE).withValue(40.0000001)
                    .build()))
                .build(),
            Depth.builder().withDepth(10D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(40D).build()))
                .build(),
            Depth.builder().withDepth(-10D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(30D).build()))
                .build(),
            Depth.builder().withDepth(20D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(20D).build()))
                .build(),
            Depth.builder().withDepth(3000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(10D).build()))
                .build(),
            ...
            Depth.builder().withDepth(50D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(-2.5).build()))
                .build(),
            Depth.builder().withDepth(60D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(-2.5000001).build()))
                .build()
        ))
        .build();
...
//    );
    ...
    CastCheckResult expected = CastCheckResult.builder()
        .withCastNumber(123)
        .withPassed(false)
        .withFailedDepths(Arrays.asList(0, 2, 4, 7))
        .build();
