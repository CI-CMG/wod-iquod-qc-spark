...
public class CoTeDeRateOfChangeCheckSparkTest {
  ...
  private final CoTeDeRateOfChangeCheck check = (CoTeDeRateOfChangeCheck) ServiceLoader.load(CastCheck.class).iterator().next();
