...
public class CoTeDeRateOfChangeCheckTest {
  ...
  void testRateOfChangeFromCastTemperatureFailure() {
    ...
    Collection<Integer> results = new CoTeDeRateOfChangeCheck().getFailedDepths(cast);
    assertEquals(3, results.size());
    assertEquals(List.of(9, 10, 14), results);
  }

  @Test
  void testRateOfChangeFromCastPressureFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
  ...
  @Test
  void testRateOfChangeFromCastSalinityFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
  ...
  @Test
  void testRateOfChangeFromCastMixedFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
                .mapToObj(v -> Depth.builder().withDepth(100D)
                    .withData(List.of(
                        ProfileData.builder()
                            ...
                            .build(),
                        ProfileData.builder()
                            .withVariableCode(PRESSURE).withValue(v)
                            .build(),
                        ProfileData.builder()
