...
public class ConstantClusterSizeTest {
  ...
  private static final double[] TEMPERATURES1 = {25.32, 25.34, 25.34, 25.31, 24.99, 23.46, 21.85, 17.95, 15.39, 11.08, 6.93, 7.93, 5.71, 3.58,
      Double.NaN};
  private static final double[] TEMPERATURES2 = {25.32, 25.34, 25.34, 25.24, 24.99, 23.46, 17.87, 17.95, 17.85, Double.NaN, 6.93, Double.NaN, 5.71,
      5.61, Double.NaN};
