...
public class CoTeDeSpikeGTSPPCheckSparkTest {
  ...
  private final CoTeDeSpikeGTSPPCheck check = (CoTeDeSpikeGTSPPCheck) ServiceLoader.load(CastCheck.class).iterator().next();
