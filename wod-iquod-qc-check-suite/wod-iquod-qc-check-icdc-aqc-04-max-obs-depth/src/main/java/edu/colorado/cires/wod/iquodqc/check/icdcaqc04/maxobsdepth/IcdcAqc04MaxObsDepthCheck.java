  ...
  protected Collection<Integer> getFailedDepths(Cast cast) {
    ...
    if (probeType.equals(OptionalInt.of(ProbeTypeConstants.STD)) || probeType.equals(OptionalInt.of(ProbeTypeConstants.XCTD)) ||
      ...
      zlast = 1200.0;
        ...
        (probeType.equals(OptionalInt.of(ProbeTypeConstants.MBT)) || probeType.equals(OptionalInt.of(ProbeTypeConstants.DBT)) || probeType.equals(
            OptionalInt.of(ProbeTypeConstants.MICRO_BT)))
            && "JP".equals(cast.getCountry())) {
      zlast = 295.00001;
