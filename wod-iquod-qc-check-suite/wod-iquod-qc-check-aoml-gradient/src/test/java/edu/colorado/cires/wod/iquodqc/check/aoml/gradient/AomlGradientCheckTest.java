        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(200000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    ...
                    .withVariableCode(TEMPERATURE).withValue(400000D).build()))
                .build(),
            Depth.builder().withDepth(300000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariableCode(TEMPERATURE).withValue(299999D).build()))
                .build()
        ))
        .build();
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(100000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariableCode(TEMPERATURE).withValue(480000D)
                    .build()))
                .build(),
            Depth.builder().withDepth(200000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariableCode(TEMPERATURE).withValue(500000D).build()))
                .build(),
            Depth.builder().withDepth(299999D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariableCode(TEMPERATURE).withValue(520000D).build()))
                .build()
        ))
        .build();
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(2D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariableCode(TEMPERATURE).withValue(1.8)
                    .build()))
                .build(),
            Depth.builder().withDepth(1D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariableCode(TEMPERATURE).withValue(1D).build()))
                .build()
        ))
        .build();
