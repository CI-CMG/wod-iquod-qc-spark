...
class EnConstantValueCheckTest {
  ...
  private final EnConstantValueCheck check = (EnConstantValueCheck) ServiceLoader.load(CastCheck.class).iterator().next();
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(1000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withVariableCode(TEMPERATURE).withValue(10D)
                    .build()))
                .build()
        ))
        .build();
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(7D)
                .withData(Collections.singletonList(ProfileData.builder()
                    ...
                    .build()))
                .build(),
            Depth.builder().withDepth(8D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withVariableCode(TEMPERATURE).withValue(0D)
                    .build()))
                .build(),
            Depth.builder().withDepth(9D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withVariableCode(TEMPERATURE).withValue(0D)
                    .build()))
                .build(),
