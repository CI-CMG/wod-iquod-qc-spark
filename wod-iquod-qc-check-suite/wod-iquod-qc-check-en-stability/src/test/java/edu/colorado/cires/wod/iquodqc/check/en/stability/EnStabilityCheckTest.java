        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(0D)
                .withData(Arrays.asList(
                    ProfileData.builder().withVariable(TEMPERATURE).withValue(13.5).build(),
                    ProfileData.builder().withVariable(SALINITY).withValue(40D).build(),
                    ProfileData.builder().withVariable(PRESSURE).withValue(8000D).build()
                    ))
                .build(),
            Depth.builder().withDepth(10D)
                .withData(Arrays.asList(
                    ProfileData.builder().withVariable(TEMPERATURE).withValue(25.5).build(),
                    ProfileData.builder().withVariable(SALINITY).withValue(35D).build(),
                    ProfileData.builder().withVariable(PRESSURE).withValue(2000).build()
                    ))
                .build(),
            Depth.builder().withDepth(20D)
                .withData(Arrays.asList(
                    ProfileData.builder().withVariable(TEMPERATURE).withValue(20.4).build(),
                    ProfileData.builder().withVariable(SALINITY).withValue(20D).build(),
                    ProfileData.builder().withVariable(PRESSURE).withValue(1000D).build()
                    ))
                .build(),
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(10D)
                .withData(Arrays.asList(
                    ProfileData.builder().withVariable(TEMPERATURE).withValue(25.5).build(),
                    ProfileData.builder().withVariable(SALINITY).withValue(35D).build(),
                    ProfileData.builder().withVariable(PRESSURE).withValue(2000D).build()
                ))
                .build(),
            Depth.builder().withDepth(20D)
                .withData(Arrays.asList(
