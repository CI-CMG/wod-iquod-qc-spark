...
public class CompromiseGroupCheckTest {
  ...
  private static final CompromiseGroupCheck check = (CompromiseGroupCheck) ServiceLoader.load(CastCheck.class).iterator().next();
