        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(100D)
                .withData(Collections.singletonList(ProfileData.builder()
                    ...
                    .withVariable(TEMPERATURE).withValue(-2.50)
                    .build()))
                .build(),
            Depth.builder().withDepth(200D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(40.0)
                    .build()))
                .build()
        ))
        .build();
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(100D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(-2.500000001)
                    .build()))
                .build(),
            Depth.builder().withDepth(200D)
                .withData(Collections.singletonList(ProfileData.builder()
        ...
        .withDepths(Arrays.asList(
            Depth.builder().withDepth(ObsUtils.pressureToDepth(-5.0000001,lat))
                .withData(Collections.singletonList(ProfileData.builder()
                    ...
                    .build()))
                .build(),
            Depth.builder().withDepth(ObsUtils.pressureToDepth(-5.00,lat))
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(0)
                    .build()))
