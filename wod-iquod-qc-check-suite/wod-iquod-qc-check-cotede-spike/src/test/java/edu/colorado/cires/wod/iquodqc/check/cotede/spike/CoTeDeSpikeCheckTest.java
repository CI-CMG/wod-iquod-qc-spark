...
public class CoTeDeSpikeCheckTest {
  ...
  @Test void testSpikeFromCastTemperatureFailure() {
    ...
    Collection<Integer> results = new CoTeDeSpikeCheck().getFailedDepths(cast);
    assertEquals(3, results.size());
    assertEquals(List.of(2, 9, 14), results);
  }

  @Test void testSpikeFromCastPressureFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
  ...
  @Test void testSpikeFromCastSalinityFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
  ...
  @Test void testSpikeFromCastMixedFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
