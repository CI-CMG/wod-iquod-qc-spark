...
class ArgoGradientCheckTest {
  ...
  private final ArgoGradientCheck check = (ArgoGradientCheck) ServiceLoader.load(CastCheck.class).iterator().next();
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(100D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(2)
                    .build()))
                .build(),
            Depth.builder().withDepth(200D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(11)
                    .build()))
                .build(),
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(200D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(-7)
                    .build()))
                .build(),
            Depth.builder().withDepth(300D)
                .withData(Collections.singletonList(ProfileData.builder()
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(200D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(11.0001)
                    .build()))
                .build(),
            Depth.builder().withDepth(300D)
                .withData(Collections.singletonList(ProfileData.builder()
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(200D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(-7.0001)
                    .build()))
                .build(),
            Depth.builder().withDepth(300D)
                .withData(Collections.singletonList(ProfileData.builder()
...
@Test
  public void testArgoGradientCheckPassPositiveSpikeDeep() throws Exception{
    // pass a marginal positive spike (criteria exactly 9 C)
    // deep - depth > 500 m
    Cast cast = Cast.builder()
        .withLatitude(0)
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(2000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(5)
                    .build()))
                .build(),
  ...
  @Test
  public void testArgoGradientCheckPassNegativeSpikeDeep() throws Exception{
    // pass a marginal negative spike (criteria exactly 9 C)
    // deep - depth > 500 m
    Cast cast = Cast.builder()
        .withLatitude(0)
  ...
  @Test
  public void testArgoGradientCheckFailPositiveSpikeDeep() throws Exception{
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(2000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(5.0001)
                    .build()))
                .build(),
            Depth.builder().withDepth(3000D)
                .withData(Collections.singletonList(ProfileData.builder()
  ...
  @Test
  public void testArgoGradientCheckFailNegativeSpikeDeep() throws Exception{
    ...
    Cast cast = Cast.builder()
        ...
        .withDepths(Arrays.asList(
            ...
            Depth.builder().withDepth(2000D)
                .withData(Collections.singletonList(ProfileData.builder()
                    .withOriginatorsFlag(0).withQcFlag(0)
                    .withVariable(TEMPERATURE).withValue(-1.0001)
                    .build()))
                .build(),
            Depth.builder().withDepth(3000D)
                .withData(Collections.singletonList(ProfileData.builder()
  ...
  @Test
  public void testArgoGradientCheckFailThreshold() throws Exception{
  ...
  @Test
  public void testArgoGradientCheckPassThreshold() throws Exception{
    // middle value should fail the deep check but pass the shallow check;
    // at threshold, use deep criteria
