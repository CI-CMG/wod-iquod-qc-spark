...
public class CoTeDeGlobalRangeGTSPPCheckSparkTest {
  ...
  private final CoTeDeGlobalRangeGTSPPCheck check = (CoTeDeGlobalRangeGTSPPCheck) ServiceLoader.load(CastCheck.class).iterator().next();
  ...
  @Test void testDigitRolloverFromCastTemperatureFailure() {
    ...
    CastCheckResult expected = CastCheckResult.builder()
        .withCastNumber(123)
        .withPassed(false)
        .withFailedDepths(List.of(0,1,5,6,8))
        .build();
