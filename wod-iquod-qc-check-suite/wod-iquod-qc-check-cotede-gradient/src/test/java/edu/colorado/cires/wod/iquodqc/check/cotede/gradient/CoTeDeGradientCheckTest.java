...
public class CoTeDeGradientCheckTest {
  ...
  void testGradientFromCastTemperatureFailure() {
    ...
    Collection<Integer> results = new CoTeDeGradientCheck().getFailedDepths(cast);
    assertEquals(3, results.size());
    assertEquals(List.of(10, 11, 14), results);
  }

  @Test void testGradientFromCastPressureFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
  ...
  @Test void testGradientFromCastSalinityFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
  ...
  @Test void testGradientFromCastMixedFailure() {
    Cast cast = Cast.builder()
        .withDepths(
            Arrays.stream(VALUES)
