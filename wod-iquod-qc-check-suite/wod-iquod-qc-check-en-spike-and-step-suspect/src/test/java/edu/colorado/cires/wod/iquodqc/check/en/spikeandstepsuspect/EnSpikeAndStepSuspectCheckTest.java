...
class EnSpikeAndStepSuspectCheckTest {
  ...
  private final EnSpikeAndStepSuspectCheck check = (EnSpikeAndStepSuspectCheck) ServiceLoader.load(CastCheck.class).iterator().next();
