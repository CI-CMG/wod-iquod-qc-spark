...
public class HighTruePositiveRateGroupCheckTest {
  ...
  private static final HighTruePositiveRateGroupCheck check = (HighTruePositiveRateGroupCheck) ServiceLoader.load(CastCheck.class).iterator().next();
